  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        centerTitle: true,
        title: Text('AÇIK KUTU PROFİL Hesaplama'),
      ),
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildTextField(_kenar1Controller, '1. Kenar (cm)', Icons.horizontal_rule, 'Örn: 40'),
            _buildTextField(_kenar2Controller, '2. Kenar (cm)', Icons.horizontal_rule, 'Örn: 30'),
            _buildTextField(_kenar3Controller, '3. Kenar (cm)', Icons.horizontal_rule, 'Örn: 40'),
            _buildTextField(_kenar4Controller, '4. Kenar (cm)', Icons.horizontal_rule, 'Örn: 30'),
