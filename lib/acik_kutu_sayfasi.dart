...
class AcikKutuSayfasi extends StatefulWidget {
  const AcikKutuSayfasi({super.key});
  @override
  State<AcikKutuSayfasi> createState() => _AcikKutuSayfasiState();
}

class _AcikKutuSayfasiState extends State<AcikKutuSayfasi> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('AÇIK KUTU PROFİL Hesaplama'),
        centerTitle: true,
      ),
      body: SafeArea(
